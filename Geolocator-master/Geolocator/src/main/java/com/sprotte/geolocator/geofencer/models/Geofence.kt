package com.sample.geolocator.geofencer.models

import com.sample.geolocator.geofencer.TransitionType
import java.util.*
...
data class Geofence(
    ...
    /**
     * Event Receiver. Needs to be [com.sample.geolocator.geofencer.service.GeofenceIntentService]
     */
